describe Robot do
  ...
  context '#attack!' do
    it 'should do 10 dmg' do
      ...
      expect(@another_robot.health_points).to eq(90)
    end
  ...
  context '#heal' do
    ...
    it 'should be healed by other robot by 10 hp' do
      ...
      expect(@robot.health_points).to eq(110)
      expect(@another_robot.health_points).to eq(100)
    end
    ...
    context 'if robot has 0 hp' do
      ...
      context 'or if the other robot has 0 hp' do
        it 'should not heal others 10 hp' do
          @another_robot.health_points = 0
          @robot.heal(@another_robot)
          expect(@another_robot.health_points).to eq(0)
        end
      end
    end
